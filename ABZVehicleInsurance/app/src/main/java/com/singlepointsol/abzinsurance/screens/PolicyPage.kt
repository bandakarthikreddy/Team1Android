...
import com.singlepointsol.abzinsurance.form.PolicyForm
import com.singlepointsol.abzinsurance.viewmodel.PolicyViewModel
        ...
        Row(
           ...
           LazyRow(
               ...
               item {
                   Button(onClick = {
                       if (form.policyNo.isNotEmpty()) {
                           ...
                           viewModel.addPolicy(form.policyNo, newPolicy, context)
                       }
                   },
                       modifier = Modifier
                           .fillMaxWidth()
               ...
               item {
                   Button(onClick = {
                       if (form.policyNo.isNotEmpty()){
                           viewModel.getPolicyByPolicyNo(form.policyNo,context)
                       }
                   },
                       modifier = Modifier
                           .fillMaxWidth()
